...
URL: https://econumo.com/posts/what-is-considered-a-liquid-asset/
...
As you can see, having ready access to the assets on the "liquid" side of the scale gives you incredible financial flexibility. Getting a handle on this concept is a huge step toward building real financial security and a core part of figuring out [how to calculate your net worth](https://econumo.com/posts/how-to-calculate-net-worth/).
...
| Asset Type                | Time to Convert to Cash | Typical Value Stability |
| ------------------------- | ----------------------- | ----------------------- |
| **Cash**                  | Instant                 | Perfectly Stable        |
| **Checking/Savings Accounts** | Instant to 1 day        | Very High               |
| **Money Market Funds**    | 1–3 days                | Very High               |
| **Stocks and ETFs**       | 3–5 days                | Moderate (can fluctuate)|
| **Mutual Funds**          | 3–5 days                | Moderate to High        |
| **Bonds**                 | Days to weeks           | Moderate to High        |
| **Collectibles (Art, Wine)**  | Weeks to months         | Low (value is subjective) |
| **Real Estate**           | Months to over a year   | Variable (market dependent)|
...
To really get a feel for what makes an asset liquid, it helps to look at the other side of the coin: non-liquid (or "illiquid") assets. These are the things you own that add to your net worth on paper but can't be relied on when you're in a financial bind.
...
This financial cushion helps you smoothly manage your household cash flow, bridging the gap between paychecks or covering a large expense that's due before your salary lands. Just knowing you have that safety net reduces financial anxiety, freeing you up to focus on your bigger, long-term goals. For more ideas on how to get started, check out our articles on building an effective [emergency fund](https://econumo.com/tags/emergency-fund/).
...
If you need a hand setting up different types of accounts to track, you can find more information in our [guide on managing accounts in Econumo](https://econumo.com/docs/user-guide/accounts/).
