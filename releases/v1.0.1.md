...
**Note**
On the public [demo](https://beta.econumo.com) the version reads **beta** because it's a development build, so it isn't linked — a versioned release shows something like **v1.0.1** and links to its notes.
