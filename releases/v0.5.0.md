...
URL: https://econumo.com/releases/v0.5.0/

The **v0.5.0** release introduces user onboarding and a calculator widget for transactions, alongside a large batch of budget refinements and bug fixes.
